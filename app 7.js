...
function renderSubjectQuiz() {
  ...
  return `
    ...
    <section class="question-card question-card-pointers">
      ${state.subjectQuestionIndex === 0 ? `<span class="side-pointer side-pointer-left">👆</span>` : ""}
      ...
      ${state.subjectQuestionIndex === 0 ? `<span class="side-pointer side-pointer-right">👆</span>` : ""}
    </section>
    ...
    <div class="quiz-nav">
      ...
      ${
        state.subjectQuestionIndex === 0
          ? `<div class="honesty-note">Look up — answer honestly, based on what you'd actually do. It's the only way this test can place you accurately.</div>`
          : ""
      }
    </div>
  `;
